...
def optimize(args):
    ...
    penalty = 0.25 * (attack_success_stats["failed_attacks"] / (attack_success_stats["failed_attacks"]+attack_success_stats["successful_attacks"]))
    ...
    df.to_csv("results_500.csv", index=False)
    return loss
