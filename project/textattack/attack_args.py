...
class AttackArgs:
    ...
    Args:
        ...
        use_timer (:obj:`bool`, `optional`, defaults to :obj:`False`):
            If `True`, use a timer to measure each stage of the attack time.
    """
    ...
    def _add_parser_args(cls, parser):
        ...
        parser.add_argument(
            "--use-timer",
            action="store_true",
            default=default_obj.use_timer,
            help="Whether to use a timer to measure each stage of the attack time.",
        )
